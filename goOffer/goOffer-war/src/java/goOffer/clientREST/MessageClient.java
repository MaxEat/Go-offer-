 ...
 * [gooffer.rest.entities.message]<br>
 * USAGE:
 * <pre>
...
public class MessageClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/goOffer-war/webresources";

    public MessageClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("gooffer.rest.entities.message");
    }
