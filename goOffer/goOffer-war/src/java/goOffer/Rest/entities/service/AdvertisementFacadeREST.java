 ...
 */
@Stateless
@Path("gooffer.rest.entities.advertisement")
public class AdvertisementFacadeREST extends AbstractFacade<Advertisement> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Advertisement entity) {
        super.edit(entity);
    }
    ...
    public Advertisement find(@PathParam("id") Integer id) {
